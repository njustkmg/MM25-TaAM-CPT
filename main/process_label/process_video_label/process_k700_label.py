...
data2cls = {
    "k700_classname_synonyms": k700_classname_synonyms,
    "k700_object_categories": k700_object_categories,
}
...
def synonyms_no_process():
    ...
    cls_num = len(k700_object_categories)
    ...
    for text in tqdm(data):
        ...
        for l in labels:
            ...
            if l in k700_object_categories:
                onehot_caption[k700_object_categories.index(l)]=1
...
def create_multimodal_dataset(config):
    ...
    dataset2train_text_paths['k700']['is_video_audio_image']=config.dataset.k700.is_video_audio_image
    dataset2train_text_paths['k700']['classname_synonyms']=data2cls['k700_classname_synonyms']
    dataset2train_text_paths['k700']['object_categories']=data2cls['k700_object_categories']
    dataset2train_text_paths['k700']['use_synonyms']=config.dataset.k700.is_video_audio_image
    dataset2train_text_paths['k700']['train_text_path']=config.dataset.k700.train_text_path

    return dataset2train_text_paths

cache_file='cache/train_new_label/test_01_k700_925.pkl'
