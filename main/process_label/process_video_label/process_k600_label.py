...
data2cls = {
    "k600_classname_synonyms": k600_classname_synonyms,
    "k600_object_categories": k600_object_categories,
}
...
def synonyms_no_process():
    ...
    cls_num = len(k600_object_categories)
    ...
    for text in tqdm(data):
        ...
        for l in labels:
            ...
            if l in k600_object_categories:
                onehot_caption[k600_object_categories.index(l)]=1
...
def create_multimodal_dataset(config):
    ...
    dataset2train_text_paths['k600']['is_video_audio_image']=config.dataset.k600.is_video_audio_image
    dataset2train_text_paths['k600']['classname_synonyms']=data2cls['k600_classname_synonyms']
    dataset2train_text_paths['k600']['object_categories']=data2cls['k600_object_categories']
    dataset2train_text_paths['k600']['use_synonyms']=config.dataset.k600.is_video_audio_image
    dataset2train_text_paths['k600']['train_text_path']=config.dataset.k600.train_text_path

    return dataset2train_text_paths

cache_file='cache/train_new_label/test_01_k600_925.pkl'
