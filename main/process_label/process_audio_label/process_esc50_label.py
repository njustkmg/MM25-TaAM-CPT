...
data2cls = {
    ...
    # "us8k_classname_synonyms": us8k_classname_synonyms,
    # "us8k_object_categories": us8k_object_categories,
}
...
def synonyms_process(train_text_path, nameset_compound, nameset, clsname2idx_use_synonyms):
    ...
    cls_num = len(esc50_object_categories)
...
def create_multimodal_dataset(config):
    ...
    # dataset2train_text_paths['us8k']['is_video_audio_image']=config.dataset.us8k.is_video_audio_image
    # dataset2train_text_paths['us8k']['classname_synonyms']=data2cls[f'us8k_classname_synonyms']
    # dataset2train_text_paths['us8k']['object_categories']=data2cls[f'us8k_object_categories']
    # dataset2train_text_paths['us8k']['use_synonyms']=config.dataset.us8k.is_video_audio_image
    # dataset2train_text_paths['us8k']['train_text_path']=config.dataset.us8k.train_text_path

    return dataset2train_text_paths

cache_file='cache/train_new_label/test_01_esc50_925.pkl'
...
for dataset_name,value in dataset2train_text_paths.items():
    ...
    for synset in classname_synonyms:
        # assert 'audio_'+synset[0] in cls2iid
        # iid = cls2iid['audio_'+synset[0]]
        for n in synset:
