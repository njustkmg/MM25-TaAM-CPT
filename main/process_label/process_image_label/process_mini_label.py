...
data2cls = {
    "mini_classname_synonyms": mini_classname_synonyms,
    "mini_object_categories": mini_object_categories,
...
def synonyms_process(train_text_path, nameset_compound, nameset, clsname2idx_use_synonyms):
    ...
    cls_num = len(mini_object_categories)
...
def create_multimodal_dataset(config):
    ...
    dataset2train_text_paths['mini']['is_video_audio_image']=config.dataset.mini.is_video_audio_image
    dataset2train_text_paths['mini']['classname_synonyms']=data2cls[f'mini_classname_synonyms']
    dataset2train_text_paths['mini']['object_categories']=data2cls[f'mini_object_categories']
    dataset2train_text_paths['mini']['use_synonyms']=config.dataset.mini.is_video_audio_image
    dataset2train_text_paths['mini']['train_text_path']=config.dataset.mini.train_text_path
...
cache_file='cache/train_new_label/test_01_mini_925.pkl'
