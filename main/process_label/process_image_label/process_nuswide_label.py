...
def synonyms_process(train_text_path, nameset_compound, nameset, clsname2idx_use_synonyms):
    ...
    data_nus = open('training_data/nuswide_10w.txt','r').readlines()[::2]

    data = data_nus

    cls_num = len(nuswide_object_categories)
...
cache_file='cache/train_new_label/test_01_nuswide_925.pkl'
